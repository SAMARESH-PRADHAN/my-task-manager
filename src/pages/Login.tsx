          ...
          <Tabs defaultValue="admin" className="w-full">
            ...
            <TabsContent value="admin">
              <form onSubmit={handleAdminLogin} className="space-y-6">
                ...
                <div className="p-4 bg-muted rounded-lg">
                  <p className="text-sm font-medium text-muted-foreground mb-2">Demo Admin Credentials:</p>
                  <p className="text-sm">admin@cafeconnect.com / admin123</p>
                </div>
              </form>
            </TabsContent>
            ...
            <TabsContent value="employee">
              <form onSubmit={handleEmployeeLogin} className="space-y-6">
                ...
                <div className="p-4 bg-muted rounded-lg">
                  <p className="text-sm font-medium text-muted-foreground mb-2">Demo Employee Credentials:</p>
                  <p className="text-sm">john@cafeconnect.com / employee123</p>
                </div>
              </form>
            </TabsContent>
          </Tabs>
